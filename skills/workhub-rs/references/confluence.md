...
| `cli confluence content label remove <content-id> <label>` | Remove a label from content. | `workhub cli confluence content label remove 123456 roadmap` | Operation summary by default; remaining labels and cleanup hint with `--json`. |
...
| `cli confluence page delete <page-id> --confirm-id <page-id>` | Delete a page after confirm-id validation and preflight read. | `workhub cli confluence page delete 123456 --confirm-id 123456` | Delete operation summary by default; operation result with cleanup hint and preflight metadata using `--json`. |
...
| `cli confluence page comment update <page-id> <comment-id> (--body <text> \| --body-file <path> \| --body-stdin)` | Update an existing page comment. | `workhub cli confluence page comment update 123456 98765 --body-file ./comment.md` | Updated comment summary by default; comment object with `--json`. |
| `cli confluence page comment delete <page-id> <comment-id>` | Delete an existing page comment. | `workhub cli confluence page comment delete 123456 98765` | Cleanup summary by default; operation result with `--json`. |
...
| `cli confluence attachment delete <attachment-id> --confirm-id <attachment-id>` | Delete an attachment after confirm-id validation and preflight read. | `workhub cli confluence attachment delete att123 --confirm-id att123` | Delete operation summary by default; operation result with cleanup hint and preflight metadata using `--json`. |
