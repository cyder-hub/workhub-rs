...
| `cli gitlab mr note add <project> <iid> (--body <text> \| --body-file <path> \| --body-stdin)` | Add a merge request note. | `workhub cli gitlab mr note add group/project 7 --body-file ./mr-note.md` | New note summary by default; note object with `--json`. |
