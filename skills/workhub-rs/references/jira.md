...
| `cli jira issue create-batch --issues-file <path>` | Create issues from a JSON file. | `workhub cli jira issue create-batch --issues-file ./jira-issues.json` | Per-issue create results by default; batch result object with `--json`. |
